...
(function(){
    ...
    p.init = function (type,multiplier,string) {
        ...
        this._winTypeText = system.CustomMethods.makeText(string, '30px Russo One', '#56ea4c', 'left', 'hanging');
        system.CustomMethods.cacheText(this._winTypeText);
        this._winValueText = system.CustomMethods.makeText('0.00', '30px Russo One', '#56ea4c', 'right', 'hanging');
        this._winValueText.x = 688;
